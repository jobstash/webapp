...
description: Use when implementing loading states, error handling, code splitting, or preventing layout shift - covers Suspense, ErrorBoundary, dynamic imports, and layout composition
---
...
```tsx
// feature.layout.tsx - shared structure
