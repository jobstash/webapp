...
export const JobItem = ({ job }: Props) => {
  ...
  return (
    <div className='relative'>
      ...
      />
      <div className='selectable-text pointer-events-none relative z-20 flex w-full flex-col gap-4 rounded-2xl border border-neutral-800/80 bg-sidebar p-4 select-text md:p-6'>
