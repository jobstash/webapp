...
export type RangeFilterConfigValueDto = z.infer<
  typeof rangeFilterConfigValueDto
>;
...
export type SingleSelectFilterConfigDto = z.infer<
...
export const multiSelectFilterConfigDto = z.object({
  ...
  kind: z.union([
    ...
    z.literal('MULTI_SELECT_WITH_SEARCH'),
  ]),
  paramKey: nonEmptyStringSchema,
  options: z.array(selectOptionDto),
});
export type MultiSelectFilterConfigDto = z.infer<
  typeof multiSelectFilterConfigDto
>;
